...
from libs import tech_orange


@pytest.fixture
def news_object():
    return tech_orange.TechOrange()


@pytest.mark.parametrize("browser_page", [0, 1, 3, 5])
def test_tech_orange_page_response(news_object, browser_page):
...
def test_tech_orange_page_load_verification(news_object):
